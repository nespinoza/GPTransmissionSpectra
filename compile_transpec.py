...
fout.write(
    "# Wav (Angstroms) \t Rp/Rs \t Rp/RsErrUp \t Rp/RsErrDown \t Depth (ppm) \t Depthup (ppm) \t DepthDown (ppm)\n"
)
...
for wi in wis:
    ...
    try:
        ...
        if ld_law == "linear":
            try:
                fout.write(
                    "{0:.2f} \t {1:.2f} \t {2:.10f} \t {3:.10f} \t {4:.10f} \t {5:.10f} \t {6:.10f} \t {7:.10f} \t {8:.10f} \t {9:.10f} \t {10:.10f} \n".format(
                        wbins[0],
                        wbins[1],
                        v,
                        vup - v,
                ...
                fout.write(
                    "{0:d} \t {1:d} \t {2:.10f} \t {3:.10f} \t {4:.10f} \t {5:.10f} \t {6:.10f} \t {7:.10f} \t {8:.10f} \t {9:.10f} \t {10:.10f} \n".format(
                        wbins,
                        wbins,
                        v,
                        vup - v,
            ...
            try:
                fout.write(
                    "{0:.2f} \t {1:.2f} \t {2:.10f} \t {3:.10f} \t {4:.10f} \t {5:.10f} \t {6:.10f} \t {7:.10f} \t {8:.10f} \t {9:.10f} \t {10:.10f} \t {11:.10f} \t {12:.10f} \t {13:.10f} \n".format(
                        wbins[0],
                        wbins[1],
                        v,
                        vup - v,
                ...
                fout.write(
                    "{0:d} \t {1:d} \t {2:.10f} \t {3:.10f} \t {4:.10f} \t {5:.10f} \t {6:.10f} \t {7:.10f} \t {8:.10f} \t {9:.10f} \t {10:.10f} \t {11:.10f} \t {12:.10f} \t {13:.10f}\n".format(
                        wbins,
                        wbins,
                        v,
                        vup - v,
